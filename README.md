...
- **4-Panel Tactical Cockpit Layout**:
  ...
  - **Center Map Viewport (`50% Width × 75% Height`)**: OpenStreetMap base layer (toggleable Tactical Dark / Standard OSM), interactive polygon drawing & vehicle staging depot placement, color-coded zone overlays, directional route corridors, and a 60 FPS HTML5 Canvas thermal density heatmap overlay.
